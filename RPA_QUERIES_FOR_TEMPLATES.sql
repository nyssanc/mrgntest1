...
SELECT  P.CASE_CNTR,       P.MMR_CASE,         P.TEAM_ASSIGNED,
        ...
        P.VRCST_ORGN_SCR,
        P.VAR_CST_CONT,                        P.VAR_CST_CONT_NAME,     P.VAR_CST_CONT_TYPE,
