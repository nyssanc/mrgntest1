...
SELECT  distinct --REGION 
        ...
        CASE WHEN CURR_DATE = BL_DATE THEN M.BL_TRIG_MCK_CONT       ELSE M.CURR_MCK_CONT       END AS  CURR_MCK_CONT, --IT IS POSSIBLE TO ACCURATELY BE A NULL CONTRACT SO YOU NEED TO USE CURR_DATE = BL_DATE OR CHANGE THAT LOGIC IN THE MMR.
